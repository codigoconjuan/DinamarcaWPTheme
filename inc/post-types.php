...
function portfolio_post_type() {
	...
	$labels = array(
		'name'                => _x( 'Portfolio', 'Post Type General Name', 'dinamarca' ),
		'singular_name'       => _x( 'Portfolio', 'Post Type Singular Name', 'dinamarca' ),
		'menu_name'           => __( 'Portfolio', 'dinamarca' ),
		'name_admin_bar'      => __( 'Portfolio', 'dinamarca' ),
		'parent_item_colon'   => __( 'Parent Portfolio', 'dinamarca' ),
		'all_items'           => __( 'All Items', 'dinamarca' ),
		'add_new_item'        => __( 'Add New Portfolio Item', 'dinamarca' ),
		'add_new'             => __( 'Add New', 'dinamarca' ),
		'new_item'            => __( 'New Portfolio Item', 'dinamarca' ),
		'edit_item'           => __( 'Edit', 'dinamarca' ),
		'update_item'         => __( 'Update', 'dinamarca' ),
		'view_item'           => __( 'View', 'dinamarca' ),
		'search_items'        => __( 'Search', 'dinamarca' ),
	...
	$args = array(
		'label'               => __( 'portfolio', 'dinamarca' ),
		'description'         => __( 'Add an Portfolio Item', 'dinamarca' ),
		'labels'              => $labels,
	...
	register_post_type( 'portfolio-post-type', $args );
