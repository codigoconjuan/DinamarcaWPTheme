<?php
/**
 * Dinamarca functions and definitions
 *
 * @package Dinamarca
 */
 ...
 */
function dinamarca_setup() {
	/*
	 * Make theme available for translation.
	 * Translations can be filed in the /languages/ directory.
	 * If you're building a theme based on Dinamarca, use a find and replace
	 * to change 'dinamarca' to the name of your theme in all the template files
	 */
	load_theme_textdomain( 'dinamarca', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary Menu', 'dinamarca' ),
		'social' => esc_html__( 'Social Menu', 'dinamarca' ),
	) );
 ...
 */
function dinamarca_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'dinamarca_content_width', 640 );
}
add_action( 'after_setup_theme', 'dinamarca_content_width', 0 );
 ...
 */
function dinamarca_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'dinamarca' ),
		'id'            => 'sidebar-1',
		'description'   => '',
...
add_action( 'wp_enqueue_scripts', 'dinamarca_scripts' );
...
//require get_template_directory() . '/inc/dinamarca-options.php';
 ...
 */
require get_template_directory() . '/inc/titan-options.php';
